...
class ImuTracker:
    ...
    def _get_imu_samples_for_network(self, t_begin_us, t_oldest_state_us, t_end_us):
        ...
        # if self.testing_reflections:
        #     R_oldest_state_wfb = self.P@R_oldest_state_wfb
        ...
        if self.local_frame:
            ...
            Ri_z = R_oldest_state_wfb ## taking the first timestep
        ...
        return net_gyr_w, net_acc_w, pe_ts
