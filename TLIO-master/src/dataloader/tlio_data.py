...
class TlioData:
    ...
    def prepare_data(self, testing=False):
        def setup_split(split):
            ...
            dataset = SequencesDataset(
                ...
                theta_range_deg = self.theta_range_deg,
                dataloader_bias_gravity_aug = self.dataloader_bias_gravity_aug,
                accel_bias_range = self.accel_bias_range,
                gyro_bias_range = self.gyro_bias_range
            )   
    ...
    def get_train_transforms(self):
        ...
        if self.augmentation_options['yaw_augmentation']:
