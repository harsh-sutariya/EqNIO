...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, help='Configuration file [Default: {}]'.format(default_config_file),
                        default='/home/royinakj/ronin/ronin_lstm/config.json')#default_config_file 
    #/home/royinakj/ronin/ronin_lstm/config.json
    #/home/royinakj/ronin/ronin_tcn/config.json
    # common
    parser.add_argument('--type', type=str, default='lstm_bi',choices=['tcn', 'lstm', 'lstm_bi'], help='Model type')
    parser.add_argument('--data_dir', type=str, default='/home/royinakj/ronin_data/all_data', help='Directory for data files if different from list path.')
    parser.add_argument('--cache_path', type=str, default="output/tcn_cache")
    ...
    parser.add_argument('--out_dir', type=str, default="output/test_lstm/ronin_unseen")
    ...
    test_cmd.add_argument('--test_list', type=str, default="lists/list_test_unseen.txt")
    test_cmd.add_argument('--model_path', type=str, default="/home/royinakj/ronin/ronin_lstm/checkpoints/ronin_lstm_checkpoint.pt")
